...
def ventaTicketsArticulosParser():
    ...
    sqlite3Query('CREATE TABLE VENTATICKETS_ARTICULOS (ID INTEGER PRIMARY KEY, TICKET_ID INTEGER , PRODUCTO_CODIGO VARCHAR(50) , PRODUCTO_NOMBRE TEXT , CANTIDAD REAL , GANANCIA REAL, DEPARTAMENTO_ID INTEGER, PAGADO_EN TEXT , USA_MAYOREO TEXT, PORCENTAJE_DESCUENTO REAL, COMPONENTES TEXT, IMPUESTOS_USADOS TEXT, IMPUESTO_UNITARIO REAL, PRECIO_USADO REAL, CANTIDAD_DEVUELTA REAL, FUE_DEVUELTO TEXT, PORCENTAJE_PAGADO REAL);')
